Compare the generated text against these references:
...
If vocabulary doesn't match, mention it. If structure doesn't match, mention it.{preservation_instruction}
