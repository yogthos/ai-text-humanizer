...
LLM_SPEAK = {
    ...
    "prior to": "before",
    "subsequent to": "after",
    # Logic gate phrases (multi-word mechanical transitions)
    "in turn": "",
    "as such": "",
    "to this end": "",
    "by this logic": "",
    ...
    "this demonstrates": "",
    "human experience": "our experience",  # Less academic
    "supports the notion": "",
    "it will be noticed": "",
    "it is worth noting": "",
    "it bears noting": "",
    "it is evident that": "",
    "compels us": "forces us",
    "serves to": "",
    "in conclusion": "",
    "for if": "if",
    "for when": "when",
    ...
    "exhibits": "shows",
    "exemplifies": "shows",
    # Fix weird Qwen vocabulary substitutions (genuinely wrong word choices)
    "ticker": "watch",
    "cogwheel": "gear",
    "geartrain": "gears",
    "paraphernalia": "gear",
